...
`app.R` contains the R code to produce a Shiny App in which expression patterns of *P. knowlesi* A1-H.1 ([De Meulenaere et al., 2026](https://doi.org/10.64898/2026.02.09.704036)), *P. vivax* ([Zhu et al., 2016](https://doi.org/10.1038/srep20498)) and *P. falciparum* ([Subudhi et al., 2020](https://doi.org/10.1038/s41467-020-16593-y)) genes can be visualised over the asexual blood stage cycle: the ['*P. knowlesi* Orthologue Expression Viewer' web tool](https://interactive.itg.be/app/pk-orthologue-expression-viewer).
...
- `Pf_expr.txt`: *P. falciparum* strain II3 (derived from 3D7) ([Subudhi et al., 2020](https://doi.org/10.1038/s41467-020-16593-y)) expression of the 25 sampled time points, and all interpolated time points.
...
The '*P. knowlesi* Orthologue Orthologue Expression Viewer' App can be accessed [here](https://interactive.itg.be/app/pk-orthologue-expression-viewer).
- In the tab 'Orthologue Expression Viewer Pk-Pv', a *P. vivax/P. knowlesi* gene is entered, the orthologue(s) are searched, and an expression plot for the input gene + orthologue(s) is given together with similarity statistics of the expression patterns.
- In the tab 'Orthologue Expression Viewer Pk-Pf', a *P. falciparum/P. knowlesi* gene is entered, the orthologue(s) are searched, and an expression plot for the input gene + orthologue(s) is given together with similarity statistics of the expression patterns.
- In the tab 'Any Gene Expression Viewer', up to 4 *P. knowlesi/P. vivax/P. falciparum* genes are entered, and one expression plot is given for all input genes together.
